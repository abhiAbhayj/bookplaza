        ...
        <div class="container-fluid">
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    ...
                    <form action="seller/controller/register.php" method="POST" enctype="multipart/form-data">
                        ...
                        <label for="floatingText">State</label>
                            <textarea type="text" name="state" class="form-control" id="floatingText" placeholder="State" required></textarea>
                        ...
                        <div class="form-floating mb-3">
                        <label for="floatingInput">Upload Certificate</label>
                            <input type="file" name="cert" class="form-control" id="floatingInput" required>
                           
                        </div>
                        <div class="form-floating mb-3">
                        <label for="floatingInput">Upload Government issued Identiy cards</label>

...
$stmt = $admin->ret("SELECT * FROM `usedbook` inner join `category` on usedbook.cat_id= category.cat_id WHERE `ubook_id`='$bookid'");
 ...
 ?>
    ...
    <div>
        <div class="row px-xl-5" style="padding: 50px;">
            <div>
                <img style="margin-right: 100px;" height="430px" width="290px" src="controller/<?php echo $row['ubook_img'] ?>" alt="Image">
            </div>
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <form action="controller/usedaddtocart.php" method="POST">
                        <input type="hidden" name="ubookid" value="<?php echo $row['ubook_id'] ?>">
                        <input type="hidden" name="cqty" value="1">
                        <button class="btn btn-primary px-3" type="submit" name="usedbookaddtocart"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button>
                    </form>

    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                    <?php
                    $stmt = $admin->ret("SELECT * FROM `usedbook` INNER JOIN `user` ON user.user_id=usedbook.user_id GROUP BY user.user_id");
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
                        <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                            <div class="card product-item border-0 mb-4">
                                <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                    <a href="viewpublicseller.php?uid=<?php echo $row['user_id'] ?>"> <img class="img-fluid" style="height:260px; width:340px" src="controller/<?php echo $row['user_img'] ?>" alt=""></a>
                                </div>
                                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                    <h6 class="text-truncate mb-3"><?php echo $row['user_name'] ?></h6>

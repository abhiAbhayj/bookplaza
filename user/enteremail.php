                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a  class="">
                                <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Enter your email address.</h3>
                            </a>
                        ...
                        <button type="submit" name="enteremail" class="btn btn-primary py-3 w-100 "> Submit</button>

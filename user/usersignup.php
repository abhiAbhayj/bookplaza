                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form action="controller/register.php" method="POST" enctype="multipart/form-data">
                            ...
                            <label for="floatingText">Phone Number</label>
                                <input type="text" name="phone" class="form-control" id="floatingText" placeholder="Enter your Phone no" pattern="[0-9]{10}" title="Please Enter Valid Number" required>
                            </div>
                            ...
                            <label for="floatingInput">Profile Photo</label>
                                <input type="file" name="img" class="form-control" id="floatingInput" placeholder="name@example.com" required>
                        ...
                        <p class="text-center mb-0">Already have an Account? <a href="userlogin.php">Log In</a></p>
                    </div>
                </div>
            </div>
        </div>

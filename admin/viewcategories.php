...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100" style="margin-top: 20px;">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-book" aria-hidden="true"></i>Manage Category</a>
                <div class="dropdown-menu bg-transparent border-0">
                ...
                <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="controller/addcat.php" method="post">
                                ...
                                <button type="submit" name="addcat" class="btn btn-primary">Add in</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">List of Category</h6>
                                    ...
                                    <tbody>
                                        ...
                                        while($row=$stmt->fetch(PDO::FETCH_ASSOC)){ ?>
                                         <tr>
                                            ...
                                            <td class="align-middle"><a href="controller/deletecat.php?cat_id=<?php echo $row['cat_id'] ?>" class="btn btn-sm btn-primary"><i class="fa fa-times"></i></a></td>
                                            <td></td>

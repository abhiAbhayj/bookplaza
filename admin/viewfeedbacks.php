...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100" style="margin-top: 20px;">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-comments" aria-hidden="true"></i>Manage Feedback</a>
                <div class="dropdown-menu bg-transparent border-0">
        ...
        <?php
            ...
            <div>
                <div class="col-md-12" style="padding: 40px;">
                    <h4 style="margin-left:50px ;">Customer Feedback</h4>
                    <div class="card-body">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                $stmt = $admin->ret("SELECT * FROM `genfeed` INNER JOIN `user` ON user.user_id=genfeed.user_id");
                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
                                    ...
                                    <tr class="text-white">
                                        ...
                                        <td>
                                            <?php echo $row['genfeed'] ?>
                                        </td>
                                        <td>
                                            <?php echo $row['genfeed_date'] ?>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>

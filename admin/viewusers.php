...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100" style="margin-top: 20px;">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-user" aria-hidden="true"></i> Manage Users</a>
                <div class="dropdown-menu bg-transparent border-0">
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">List of Registered Users</h6>
                                    ...
                                    <?php
                                        ...
                                        while($row=$stmt->fetch(PDO::FETCH_ASSOC)){ ?>
                                         <tr class="text-white">
                                            ...
                                            <td><a href="controller/deleteuser.php?uid=<?php echo $row['user_id'] ?>" onclick="return confirm('Are you sure?')"><i class="fa fa-trash" style="font-size: 20px;margin-left:20px"></i></a></td>

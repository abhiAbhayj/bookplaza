...
$stmt2 = $admin->ret("SELECT * FROM `seller`");
$seller = $stmt2->rowCount();

$stmt3 = $admin->ret("SELECT * FROM `category`");
$cat = $stmt3->rowCount();
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php echo $seller ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="viewfeedbacks.php">View All</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <?php
                                $count = 1;
                                $stmt5 = $admin->ret("SELECT * FROM `genfeed` INNER JOIN `user` ON user.user_id=genfeed.user_id order by`genfeed_date`DESC");
...
<?php echo $count++ ?>
                                        ...
                                        <td>
                                            <?php echo $row5['user_email'] ?>
                                        </td>
                                        <td>
                                           <textarea name="" id="" cols="30" rows="4" readonly><?php echo $row5['genfeed'] ?></textarea>
                                        </td>
                                        <td>
                                            <?php echo $row5['genfeed_date'] ?>
                                        </td>
                                    </tr>
                                <?php }
                                ?>

                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                            <div>
                                <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                 <a href="sellerdetail.php?slid=<?php echo $row['seller_id'] ?>">   <img height="200px" width="300px" src="../seller/controller/<?php echo $row['seller_image'] ?>" alt=""></a>
                                </div>
                                <div class="mt-4"> 
                                    <h6><?php echo $row['seller_name'] ?></h6>

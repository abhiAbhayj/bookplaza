...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-tasks"></i>Manage Report</a>
                <div class="dropdown-menu bg-transparent border-0">
                                        ...
                                        <div class="table-responsive" style="margin-top: 50px;">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $stmt = $admin->ret("SELECT * FROM `order` INNER JOIN `book` ON book.book_id=order.book_id INNER JOIN `user` ON user.user_id=order.user_id  WHERE  `od_date` between '$start_date' and '$end_date' AND order.seller_id='$sid'");

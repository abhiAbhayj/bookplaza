...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-comments"></i>Manage Feedback</a>
                <div class="dropdown-menu bg-transparent border-0">
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">View Feedbacks</h6>
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php
                                        $count = 1;
                    $stmt = $admin->ret("SELECT * FROM `feedback` INNER JOIN `user` ON user.user_id=feedback.user_id INNER JOIN `book` ON book.book_id=feedback.book_id WHERE feedback.seller_id='$sid'");
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
                                            <tr style="color: white;">
                                                ...
                                                <td>
                                                   <textarea name="" id="" cols="30" rows="4" readonly><?php echo $row['feed'] ?></textarea>
                                                </td>
                                                <td>
                                                    <?php echo $row['fb_date'] ?>
                                                </td>

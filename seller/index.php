...
$sid = $_SESSION['sid'];
$stmt1 = $admin->ret("SELECT * FROM `book` WHERE seller_id='$sid'");
$book = $stmt1->rowCount();


$stmt2 = $admin->ret("SELECT * FROM `order` WHERE seller_id='$sid'");
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php echo $book ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php echo $order ?></h6>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="vieworders.php">View All</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <?php
                                $count = 1;
                                $stmt3 = $admin->ret("SELECT * FROM `order` INNER JOIN `user` ON user.user_id=order.user_id INNER JOIN `book` ON book.book_id=order.book_id WHERE order.seller_id='$sid' AND `od_date`=CURDATE()");
                                while ($row3 = $stmt3->fetch(PDO::FETCH_ASSOC)) { ?>
                                    ...
                                    <?php echo $count++ ?>
                                        ...
                                        <td>
                                            <?php echo $row3['user_email'] ?>
                                        </td>
                                        <td>
                                            <?php echo $row3['book_title'] ?>
                                        </td>
                                        <td>
                                            <?php echo $row3['od_date'] ?>
                                        </td>
                                    </tr>
                                <?php }
                                ?>

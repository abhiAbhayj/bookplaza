        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <a href="viewbooks.php" class="dropdown-item active">View Books</a>
                ...
                <div class="">
                    <div class="col-lg-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">View Book Details</h6>
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <?php
                                        $count=1;
                                        $stmt=$admin->ret("SELECT * FROM `book` INNER JOIN `category` ON category.cat_id=book.cat_id WHERE `seller_id`='$sid'");
                                        while($row=$stmt->fetch(PDO::FETCH_ASSOC)){ ?>
                                         <tr class="text-white">
                                            ...
                                            <td>
                                                <textarea name="" id="" cols="30" rows="5" readonly><?php echo $row['book_description'] ?></textarea>
                                            </td>
                                            ...
                                            <td><a href="controller/deletebook.php?bookid=<?php echo $row['book_id'] ?>" onclick="return confirm('Are you sure?')"><i class="fa fa-trash" style="font-size:24px;margin-left:10px"></i></a></td>
